    ...
    <nav className="bg-green-700 text-white shadow-md relative">
      <div className="container mx-auto px-4 flex items-center justify-between h-20">
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <Link href="/rankings" className={`${pathname === "/rankings" ? "underline" : "hover:underline"}`}>
            Rankings
          </Link>
      ...
      {menuOpen && (
        <div className="md:hidden bg-green-700 pt-4 pb-6 space-y-4 flex flex-col items-center text-white">
          ...
          >
            ...
            <Link href="/rankings" onClick={() => setMenuOpen(false)} className="w-full text-center py-1">
              Rankings
            </Link>
          {profileUsername && (
            <Link
